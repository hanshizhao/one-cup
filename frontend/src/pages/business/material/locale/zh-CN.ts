export default {
  ...
  'material.detail.title': '物料详情',
  'material.message.deleteOk': '确定删除该物料吗?删除后不可恢复。',
  ...
  'material.error.noNumberingRule': '请先在编号管理为物料配置启用规则',
};
