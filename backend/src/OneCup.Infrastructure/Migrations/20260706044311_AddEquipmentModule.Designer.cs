...
namespace OneCup.Infrastructure.Migrations
{
    ...
    [Migration("20260706044311_AddEquipmentModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneCup.Domain.Entities.Equipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ux_equipments_code");

                    b.HasIndex("EquipmentTypeId");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ux_equipments_name");

                    b.ToTable("equipments", (string)null);
                });

            modelBuilder.Entity("OneCup.Domain.Entities.EquipmentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EquipmentTypeId", "ProcessId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ux_equipment_templates_type_process_name");

                    b.ToTable("equipment_templates", (string)null);
                });

            modelBuilder.Entity("OneCup.Domain.Entities.EquipmentTemplateValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("EquipmentTemplateId")
                        .HasColumnType("uuid")
                        .HasColumnName("equipment_template_id");
                    ...
                    b.HasIndex("EquipmentTemplateId", "ParameterId")
                        .IsUnique()
                        .HasDatabaseName("ux_equipment_template_values_template_parameter");

                    b.ToTable("equipment_template_values", (string)null);
                });

            modelBuilder.Entity("OneCup.Domain.Entities.EquipmentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ux_equipment_types_code");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ux_equipment_types_name");

                    b.ToTable("equipment_types", (string)null);
                });

            modelBuilder.Entity("OneCup.Domain.Entities.EquipmentTypeParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EquipmentTypeId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ux_equipment_type_parameters_type_name");

                    b.ToTable("equipment_type_parameters", (string)null);
                });
            ...
            modelBuilder.Entity("OneCup.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-00000000032b"),
                            Code = "process:read",
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "查看工序"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-00000000032c"),
                            Code = "process:create",
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "录入工序"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-00000000032d"),
                            Code = "process:update",
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "编辑工序"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-00000000032e"),
                            Code = "process:delete",
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "删除工序"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-00000000032f"),
                            Code = "equipment-type:read",
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "查看设备类型"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Code = "equipment-type:delete",
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "删除设备类型"
                        });
                });

            modelBuilder.Entity("OneCup.Domain.Entities.Process", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("role_permissions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            role_id = new Guid("00000000-0000-0000-0000-000000000003"),
                            permission_id = new Guid("00000000-0000-0000-0000-00000000032b")
                        },
                        new
                        {
                            role_id = new Guid("00000000-0000-0000-0000-000000000003"),
                            permission_id = new Guid("00000000-0000-0000-0000-00000000032f")
                        });
                });
            ...
            modelBuilder.Entity("OneCup.Domain.Entities.Equipment", b =>
                {
                    b.HasOne("OneCup.Domain.Entities.EquipmentType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OneCup.Domain.Entities.EquipmentTemplate", b =>
                {
                    ...
                    b.HasOne("OneCup.Domain.Entities.Process", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OneCup.Domain.Entities.EquipmentTemplateValue", b =>
                {
                    b.HasOne("OneCup.Domain.Entities.EquipmentTemplate", null)
                        .WithMany("Values")
